...
public class OldOrder extends FleaEntity {

    private static final long serialVersionUID = -7428771015892030261L;

    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "OLD_ORDER_GENERATOR")
    @TableGenerator(
        // 唯一的生成器名称，可以由一个或多个类引用以作为id值的生成器。
        name = "OLD_ORDER_GENERATOR",
        // 存储生成的ID值的表的名称
